...
% 
% names =            { a.jancaSpikeSettings.strict5000Hz.VKJlabelsName   };
% colors =           { a.jancaSpikeSettings.strict5000Hz.VKJlabelsColor  };
% jancaStrings =     { a.jancaSpikeSettings.strict5000Hz.settingsStr  };
...
%      if ~isempty(a.LabelFilter)
%         TfilesOneSub =  o.LabelFilter(TfilesOneSub);
%      end
     TiedOneFile = a.apply(What = 'labelfilter', On = TiedOneFile );
