...
drawnow;
resize2cm(9.5,10.5); % paper size on figure but axes are still on auto mode
...
ha =gca;
backupUnits = ha.Units;
ha.Units= 'centimeters';
size_a = 2.36;
wh_cm = [size_a size_a];
lb_adjust = (ha.InnerPosition(3:4)-wh_cm)/2;
ha.InnerPosition(1:2) = ha.InnerPosition(1:2) + lb_adjust;
ha.InnerPosition(3:4) = wh_cm;
ha.Units = backupUnits;
