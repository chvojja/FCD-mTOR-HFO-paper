...
%     Tsub.IEDfwelch( Tsub.Subject == subject)  = {fwelch'};
    ...
    Tsub.Rlength_ms( Tsub.Subject == subject) = mean(  Tiedf.Rlength_ms(Tiedf.Subject == subject & Tiedf.HasR==true )  ); 
    Tsub.FRlength_ms( Tsub.Subject == subject) = mean(  Tiedf.FRlength_ms(Tiedf.Subject == subject  & Tiedf.HasFR==true  )  ); 
